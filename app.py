...
with st.form("daily_time_entry_form", clear_on_submit=True):
    ...
    with entry_col1:
        entry_date = st.date_input("Date Worked", value=pay_period_start, min_value=pay_period_start - datetime.timedelta(days=365), max_value=pay_period_end + datetime.timedelta(days=365))
    with entry_col2:
